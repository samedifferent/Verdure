...
public class VerdureBlocks {
    ...
    public static final RegistryObject<Block> PEBBLES = registerBlock("pebbles", () -> new PebblesBlock(BlockBehaviour.Properties.of(Material.DECORATION).noOcclusion().sound(SoundType.STONE).instabreak().noCollission()));
    public static final RegistryObject<Block> ROCK = registerBlock("rock", () -> new RockBlock(BlockBehaviour.Properties.of(Material.DECORATION).noOcclusion().sound(SoundType.STONE).instabreak().noCollission()));
    ...
    public static final RegistryObject<Block> FALLEN_OAK_LEAVES = registerBlock("fallen_oak_leaves", () -> new FallenLeavesBlock(BlockBehaviour.Properties.of(Material.CLOTH_DECORATION).instabreak().sound(SoundType.GRASS).noOcclusion()));
    public static final RegistryObject<Block> FALLEN_BIRCH_LEAVES = registerBlock("fallen_birch_leaves", () -> new FallenLeavesBlock(BlockBehaviour.Properties.of(Material.CLOTH_DECORATION).instabreak().sound(SoundType.GRASS).noOcclusion()));
    public static final RegistryObject<Block> FALLEN_SPRUCE_LEAVES = registerBlock("fallen_spruce_leaves", () -> new FallenLeavesBlock(BlockBehaviour.Properties.of(Material.CLOTH_DECORATION).instabreak().sound(SoundType.GRASS).noOcclusion()));
    public static final RegistryObject<Block> FALLEN_JUNGLE_LEAVES = registerBlock("fallen_jungle_leaves", () -> new FallenLeavesBlock(BlockBehaviour.Properties.of(Material.CLOTH_DECORATION).instabreak().sound(SoundType.GRASS).noOcclusion()));
    public static final RegistryObject<Block> FALLEN_ACACIA_LEAVES = registerBlock("fallen_acacia_leaves", () -> new FallenLeavesBlock(BlockBehaviour.Properties.of(Material.CLOTH_DECORATION).instabreak().sound(SoundType.GRASS).noOcclusion()));
    public static final RegistryObject<Block> FALLEN_DARK_OAK_LEAVES = registerBlock("fallen_dark_oak_leaves", () -> new FallenLeavesBlock(BlockBehaviour.Properties.of(Material.CLOTH_DECORATION).instabreak().sound(SoundType.GRASS).noOcclusion()));
    ...
    public static final RegistryObject<Block> BIRCH_BRANCH = registerBlock("birch_branch", () -> new BranchBlock(Blocks.BIRCH_LOG, VerdureBlocks.FALLEN_BIRCH_LEAVES.get(), BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).noCollission().noOcclusion().strength(1.0F).sound(SoundType.WOOD)));
