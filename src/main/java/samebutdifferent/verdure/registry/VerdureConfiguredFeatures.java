...
public class VerdureConfiguredFeatures {
    ...
    public static final RegistryObject<ConfiguredFeature<?, ?>> OAK_BRANCHES_AND_LEAVES = CONFIGURED_FEATURES.register("oak_branches_and_leaves", () -> new ConfiguredFeature<>(Feature.TREE, createStraightBlobTree(Blocks.OAK_LOG, Blocks.OAK_LEAVES, 4, 2, 0, 2).ignoreVines().decorators(List.of(new BranchDecorator(BlockStateProvider.simple(VerdureBlocks.OAK_BRANCH.get())), new FallenLeavesDecorator(BlockStateProvider.simple(VerdureBlocks.FALLEN_OAK_LEAVES.get())))).build()));
    ...
    public static final RegistryObject<ConfiguredFeature<?, ?>> TREES_BIRCH_AND_OAK = CONFIGURED_FEATURES.register("trees_birch_and_oak", () -> new ConfiguredFeature<>(Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(VerdurePlacedFeatures.BIRCH_BRANCHES.getHolder().get(), 0.2F), new WeightedPlacedFeature(TreePlacements.FANCY_OAK_BEES_0002, 0.1F), new WeightedPlacedFeature(VerdurePlacedFeatures.OAK_BRANCHES_AND_LEAVES.getHolder().get(), 0.1F)), VerdurePlacedFeatures.OAK_BRANCHES.getHolder().get())));
