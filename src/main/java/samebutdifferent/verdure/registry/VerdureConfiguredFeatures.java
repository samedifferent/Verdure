...
public class VerdureConfiguredFeatures {
    ...
    public static final RegistryObject<ConfiguredFeature<?, ?>> BIRCH_BRANCHES_AND_LEAVES = CONFIGURED_FEATURES.register("birch_branches_and_leaves", () -> new ConfiguredFeature<>(Feature.TREE, createStraightBlobTree(Blocks.BIRCH_LOG, Blocks.BIRCH_LEAVES, 5, 2, 0, 2).ignoreVines().decorators(List.of(new BranchDecorator(VerdureBlocks.BIRCH_BRANCH.get().defaultBlockState()), new FallenLeavesDecorator(VerdureBlocks.FALLEN_BIRCH_LEAVES.get().defaultBlockState()))).build()));
    public static final RegistryObject<ConfiguredFeature<?, ?>> TREES_BIRCH_AND_OAK = CONFIGURED_FEATURES.register("trees_birch_and_oak", () -> new ConfiguredFeature<>(Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(VerdurePlacedFeatures.BIRCH_BRANCHES_AND_LEAVES.getHolder().get(), 0.2F), new WeightedPlacedFeature(TreePlacements.FANCY_OAK_BEES_0002, 0.1F)), VerdurePlacedFeatures.OAK_BRANCHES_AND_LEAVES.getHolder().get())));
