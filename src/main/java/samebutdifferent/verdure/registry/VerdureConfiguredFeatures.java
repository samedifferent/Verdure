...
public class VerdureConfiguredFeatures {
    ...
    public static final RegistryObject<ConfiguredFeature<?, ?>> TREES_SAVANNA = CONFIGURED_FEATURES.register("trees_savanna", () -> new ConfiguredFeature<>(Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(VerdurePlacedFeatures.ACACIA_CHECKED.getHolder().get(), 0.8F)), VerdurePlacedFeatures.OAK_CHECKED.getHolder().get())));
    public static final RegistryObject<ConfiguredFeature<?, ?>> BIRCH_TALL = CONFIGURED_FEATURES.register("birch_tall", () -> new ConfiguredFeature<>(Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(VerdurePlacedFeatures.SUPER_BIRCH_CHECKED.getHolder().get(), 0.5F)), VerdurePlacedFeatures.BIRCH_CHECKED.getHolder().get())));
    public static final RegistryObject<ConfiguredFeature<?, ?>> TREES_JUNGLE = CONFIGURED_FEATURES.register("trees_jungle", () -> new ConfiguredFeature<>(Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(TreePlacements.FANCY_OAK_CHECKED, 0.1F), new WeightedPlacedFeature(TreePlacements.JUNGLE_BUSH, 0.5F), new WeightedPlacedFeature(TreePlacements.MEGA_JUNGLE_TREE_CHECKED, 0.33333334F)), VerdurePlacedFeatures.JUNGLE_TREE_CHECKED.getHolder().get())));
    public static final RegistryObject<ConfiguredFeature<?, ?>> TREES_SPARSE_JUNGLE = CONFIGURED_FEATURES.register("trees_sparse_jungle", () -> new ConfiguredFeature<>(Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(TreePlacements.FANCY_OAK_CHECKED, 0.1F), new WeightedPlacedFeature(TreePlacements.JUNGLE_BUSH, 0.5F)), VerdurePlacedFeatures.JUNGLE_TREE_CHECKED.getHolder().get())));
    public static final RegistryObject<ConfiguredFeature<?, ?>> TREES_FLOWER_FOREST = CONFIGURED_FEATURES.register("trees_flower_forest", () -> new ConfiguredFeature<>(Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(VerdurePlacedFeatures.BIRCH_CHECKED.getHolder().get(), 0.2F), new WeightedPlacedFeature(TreePlacements.FANCY_OAK_BEES_002, 0.1F)), VerdurePlacedFeatures.OAK_CHECKED.getHolder().get())));
